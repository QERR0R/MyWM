...
static const char *b_up[] = { "xbacklight", "-inc", "5", NULL };
static const char *b_down[] = { "xbacklight", "-dec", "5", NULL };
...
static const Key keys[] = {
	...
	{ 0,	      XF86XK_MonBrightnessUp,	  spawn,	  {.v = b_up } },
	{ 0,	    XF86XK_MonBrightnessDown,	  spawn,	  {.v = b_down } },
